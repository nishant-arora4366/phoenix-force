        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              {player.stage_name && (
                <p className="text-xl text-gray-600 italic">"{player.stage_name}"</p>
              )}
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="p-8">
                ...
                {/* Roles */}
                <div className="mb-8">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Player Roles</h3>
                ...
                {/* Ratings */}
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Player Ratings</h3>
                  <div className="space-y-4">
                    {player.batting_rating && (
                      <div className="flex items-center justify-between">
                        <span className="text-gray-700 font-medium">Batting</span>
                        <div className="flex items-center">
                          ...
                          <span className="text-lg font-bold text-gray-900">{player.batting_rating}/10</span>
                        </div>
                      </div>
                    )}
                    {player.bowling_rating && (
                      <div className="flex items-center justify-between">
                        <span className="text-gray-700 font-medium">Bowling</span>
                        <div className="flex items-center">
                          <div className="w-32 bg-gray-200 rounded-full h-3 mr-3">
                            <div 
                          ...
                          <span className="text-lg font-bold text-gray-900">{player.bowling_rating}/10</span>
                        </div>
                      </div>
                    )}
                    {player.wicket_keeping_rating && (
                      <div className="flex items-center justify-between">
                        <span className="text-gray-700 font-medium">Wicket Keeping</span>
                        <div className="flex items-center">
                          <div className="w-32 bg-gray-200 rounded-full h-3 mr-3">
                            <div 
                          ...
                          <span className="text-lg font-bold text-gray-900">{player.wicket_keeping_rating}/10</span>
                        </div>
                      </div>
                    )}
                  </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-green-600">₹{player.base_price}</span>
                </div>
                {player.group_name && (
                  <div className="flex justify-between">
                    <span className="text-gray-600">Group</span>
                    <span className="font-semibold text-gray-900">{player.group_name}</span>
                  </div>
                )}
                <div className="flex justify-between">
