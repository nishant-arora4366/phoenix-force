            ...
            {filteredPlayers?.map((player) => (
              <div key={player.id} className="group relative overflow-hidden bg-gradient-to-br from-[#19171b] via-[#2b0307] to-[#51080d] rounded-xl shadow-xl border border-[#CEA17A]/20 hover:animate-border-glow transition-all duration-300 h-full flex flex-col">
                ...
                <div className="relative aspect-square bg-gradient-to-br from-[#3E4E5A] to-[#09171F] overflow-hidden">
                  ...
                  {/* Price Badge */}
                  <div className="absolute top-4 right-4 bg-[#CEA17A]/20 text-[#CEA17A] border border-[#CEA17A]/30 px-3 py-1 rounded-full text-sm font-semibold shadow-lg backdrop-blur-sm">
                    ₹{player.base_price}
                  </div>
                  
                  {/* Group Badge */}
                  {player.group_name && (
                    <div className="absolute top-4 left-4 bg-[#3E4E5A]/20 text-[#DBD0C0] border border-[#3E4E5A]/30 px-3 py-1 rounded-full text-sm font-medium shadow-lg backdrop-blur-sm">
                      {player.group_name}
                    </div>
                  )}
                </div>
