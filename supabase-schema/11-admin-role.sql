...
-- First, let's update the users table to include admin role
-- (The role column should already support 'admin' but let's ensure it)
...
-- Create an admin user (optional - you can create this manually)
